...
async function help(bot,message,language,p,args) {
    ...
    if(args[0] == "common") {
        ...
        .addFields({ name: h.command.common.title , value: h.command.common.cmd, inline: true })
        .addFields({ name: h.command.rabbit.title, value: h.command.rabbit.cmd, inline: true })
        .addFields({ name: h.command.game.title, value: h.command.game.cmd, inline: true })
        .addFields({ name: h.command.admin.title, value:  h.command.admin.cmd, inline: true })
        .addFields({ name: h.command.music.title, value: h.command.music.cmd, inline: true })
        .addFields({ name: h.command.other.title, value:h.command.other.cmd, inline: true })
        .addFields({ name: h.command.money.title, value: h.command.money.cmd, inline: true})
        .addFields({ name: h.command.level.title, value: h.command.level.cmd, inline: true})
        .addFields({ name: h.command.user.title, value: h.command.user.cmd, inline: true})
        .addFields({ name: h.command.text.title, value: h.command.text.cmd,inline: true})
        .setTimestamp()
